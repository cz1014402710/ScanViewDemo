...
/**
 * Created by chenz on 2016/12/29.
 */
public class TScanView extends View {
    ...
    public TScanView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TScanView(Context context) {
        this(context, null);
    }

    public TScanView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaint() {
        ...
        mPaintCircle.setColor(0x00000000);
        //实心圆style
...
//渐变
        //初始化一个颜色渲染器
        SweepGradient shader = new SweepGradient(viewSize / 2.0f, viewSize / 2.0f, Color.TRANSPARENT, Color.WHITE);
        //mPaintSector设置颜色渐变渲染器
        mPaintSector.setShader(shader);
        mPaintSector.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
    }
